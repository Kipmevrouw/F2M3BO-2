...
// your data
String studentName = "Becky student nummer 7978979987"; // jouw student nummer + naam
...
void handleRoot() {
   ...
   +  studentName + "</h3> <form action=\"/led1\" methode=\"GET\"><input type=\"submit\"value=\"Toggle Led1\"></form>" +
   " <form action=\"/led2\" methode=\"GET\"><input type=\"submit\"value=\"Toggle Led2\"></form>" +
   " <form action=\"/led3\" methode=\"GET\"><input type=\"submit\"value=\"Toggle Led3\"></form> "  
   );
   }
 ...
 */
  ...
  server.on("/easter_egg", [](){
        server.send(200, "text/plain", "Becky loves you");
    });
